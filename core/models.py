...
class PatrolRecord(models.Model):
    ...
    storage_location = models.ForeignKey(StorageLocation, on_delete=models.PROTECT, related_name='patrol_records', null=True, blank=True, verbose_name='原库位')
    location_code = models.CharField(max_length=50, verbose_name='原库位编码')
    ...
    return_storage_location = models.ForeignKey(StorageLocation, on_delete=models.PROTECT, related_name='returned_patrol_records', null=True, blank=True, verbose_name='归还库位')
    return_damage_level = models.IntegerField(choices=DAMAGE_LEVEL_CHOICES, null=True, blank=True, verbose_name='归还损坏等级')
    return_remark = models.TextField(blank=True, null=True, verbose_name='归还说明')
    returned_by = models.ForeignKey(User, on_delete=models.PROTECT, related_name='returned_records', null=True, blank=True, verbose_name='归还登记人')
    returned_at = models.DateTimeField(null=True, blank=True, verbose_name='归还登记时间')
